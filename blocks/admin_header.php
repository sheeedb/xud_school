...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
    ...
    <div class="button-container">
        <a class="button1" href="../admin/face2.php">Статьи</a>
        <a class="button1" href="../admin/schedule2.php">Расписание</a>
        <a class="button1" href="../admin/workers2.php">Пользователи</a>
    </div>
